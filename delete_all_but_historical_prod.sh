...
#curl -s -H 'Content-Type: application/json' -XPOST "https://elastic:8khOn4tiemn5mcYZkIa3w1OB@20e7bc15b6584b6f878c9b6d75ab8fe9.us-west-1.aws.found.io:9243/sds-hyperledger-hyperledger-all-git-converted/_search?size=10000" -d'{"query":{"bool":{"should":[{"term":{"origin":"https://github.com/hyperledger/aries-ams-sqlite"}},{"term":{"origin":"https://github.com/hyperledger-twgc/grpc-gm"}}]}}}' | jq '.hits.hits[]._source.origin' | sort | uniq
#curl -s -H 'Content-Type: application/json' -XPOST "https://elastic:8khOn4tiemn5mcYZkIa3w1OB@20e7bc15b6584b6f878c9b6d75ab8fe9.us-west-1.aws.found.io:9243/sds-hyperledger-hyperledger-all-git-converted/_search?size=10000" -d'{"query":{"bool":{"must_not":[{"term":{"origin":"https://github.com/hyperledger/aries-ams-sqlite"}},{"term":{"origin":"https://github.com/hyperledger-twgc/grpc-gm"}}]}}}' | jq '.hits.hits[]._source.origin' | sort | uniq
...
if [ ! -z "$DROP" ]
then
  curl -s -H 'Content-Type: application/json' -XPOST "https://elastic:8khOn4tiemn5mcYZkIa3w1OB@20e7bc15b6584b6f878c9b6d75ab8fe9.us-west-1.aws.found.io:9243/sds-hyperledger-hyperledger-all-git-converted/_delete_by_query" -d'{"query":{"bool":{"must_not":[{"term":{"origin":"https://github.com/hyperledger/aries-ams-sqlite"}},{"term":{"origin":"https://github.com/hyperledger-twgc/grpc-gm"}}]}}}' | jq '.deleted'
fi
declare -A data
